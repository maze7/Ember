#include <glm/ext/vector_int1_sized.hpp>
	...
	static_assert(sizeof(glm::i8vec1) == 1, "int8 size isn't 1 byte on this system");
	static_assert(sizeof(glm::i16vec1) == 2, "int16 size isn't 2 bytes on this system");
	static_assert(sizeof(glm::i32vec1) == 4, "int32 size isn't 4 bytes on this system");
	static_assert(sizeof(glm::i64vec1) == 8, "int64 size isn't 8 bytes on this system");
#endif
