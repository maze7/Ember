...
static_assert(sizeof(glm::lowp_u8vec1) == 1, "uint8 size isn't 1 byte on this system");
static_assert(sizeof(glm::mediump_u8vec1) == 1, "uint8 size isn't 1 byte on this system");
static_assert(sizeof(glm::highp_u8vec1) == 1, "uint8 size isn't 1 byte on this system");

static_assert(sizeof(glm::lowp_u16vec1) == 2, "uint16 size isn't 2 bytes on this system");
static_assert(sizeof(glm::mediump_u16vec1) == 2, "uint16 size isn't 2 bytes on this system");
static_assert(sizeof(glm::highp_u16vec1) == 2, "uint16 size isn't 2 bytes on this system");

static_assert(sizeof(glm::lowp_u32vec1) == 4, "uint32 size isn't 4 bytes on this system");
static_assert(sizeof(glm::mediump_u32vec1) == 4, "uint32 size isn't 4 bytes on this system");
static_assert(sizeof(glm::highp_u32vec1) == 4, "uint32 size isn't 4 bytes on this system");

static_assert(sizeof(glm::lowp_u64vec1) == 8, "uint64 size isn't 8 bytes on this system");
static_assert(sizeof(glm::mediump_u64vec1) == 8, "uint64 size isn't 8 bytes on this system");
static_assert(sizeof(glm::highp_u64vec1) == 8, "uint64 size isn't 8 bytes on this system");


static_assert(sizeof(glm::lowp_u8vec2) == 2, "uint8 size isn't 1 byte on this system");
static_assert(sizeof(glm::mediump_u8vec2) == 2, "uint8 size isn't 1 byte on this system");
static_assert(sizeof(glm::highp_u8vec2) == 2, "uint8 size isn't 1 byte on this system");

static_assert(sizeof(glm::lowp_u16vec2) == 4, "uint16 size isn't 2 bytes on this system");
static_assert(sizeof(glm::mediump_u16vec2) == 4, "uint16 size isn't 2 bytes on this system");
static_assert(sizeof(glm::highp_u16vec2) == 4, "uint16 size isn't 2 bytes on this system");

static_assert(sizeof(glm::lowp_u32vec2) == 8, "uint32 size isn't 4 bytes on this system");
static_assert(sizeof(glm::mediump_u32vec2) == 8, "uint32 size isn't 4 bytes on this system");
static_assert(sizeof(glm::highp_u32vec2) == 8, "uint32 size isn't 4 bytes on this system");

static_assert(sizeof(glm::lowp_u64vec2) == 16, "uint64 size isn't 8 bytes on this system");
static_assert(sizeof(glm::mediump_u64vec2) == 16, "uint64 size isn't 8 bytes on this system");
static_assert(sizeof(glm::highp_u64vec2) == 16, "uint64 size isn't 8 bytes on this system");


static_assert(sizeof(glm::lowp_u8vec3) == 3, "uint8 size isn't 1 byte on this system");
static_assert(sizeof(glm::mediump_u8vec3) == 3, "uint8 size isn't 1 byte on this system");
static_assert(sizeof(glm::highp_u8vec3) == 3, "uint8 size isn't 1 byte on this system");

static_assert(sizeof(glm::lowp_u16vec3) == 6, "uint16 size isn't 2 bytes on this system");
static_assert(sizeof(glm::mediump_u16vec3) == 6, "uint16 size isn't 2 bytes on this system");
static_assert(sizeof(glm::highp_u16vec3) == 6, "uint16 size isn't 2 bytes on this system");

static_assert(sizeof(glm::lowp_u32vec3) == 12, "uint32 size isn't 4 bytes on this system");
static_assert(sizeof(glm::mediump_u32vec3) == 12, "uint32 size isn't 4 bytes on this system");
static_assert(sizeof(glm::highp_u32vec3) == 12, "uint32 size isn't 4 bytes on this system");

static_assert(sizeof(glm::lowp_u64vec3) == 24, "uint64 size isn't 8 bytes on this system");
static_assert(sizeof(glm::mediump_u64vec3) == 24, "uint64 size isn't 8 bytes on this system");
static_assert(sizeof(glm::highp_u64vec3) == 24, "uint64 size isn't 8 bytes on this system");


static_assert(sizeof(glm::lowp_u8vec4) == 4, "int8 size isn't 1 byte on this system");
static_assert(sizeof(glm::mediump_u8vec4) == 4, "int8 size isn't 1 byte on this system");
static_assert(sizeof(glm::highp_u8vec4) == 4, "int8 size isn't 1 byte on this system");

static_assert(sizeof(glm::lowp_u16vec4) == 8, "int16 size isn't 2 bytes on this system");
static_assert(sizeof(glm::mediump_u16vec4) == 8, "int16 size isn't 2 bytes on this system");
static_assert(sizeof(glm::highp_u16vec4) == 8, "int16 size isn't 2 bytes on this system");

static_assert(sizeof(glm::lowp_u32vec4) == 16, "int32 size isn't 4 bytes on this system");
static_assert(sizeof(glm::mediump_u32vec4) == 16, "int32 size isn't 4 bytes on this system");
static_assert(sizeof(glm::highp_u32vec4) == 16, "int32 size isn't 4 bytes on this system");

static_assert(sizeof(glm::lowp_u64vec4) == 32, "int64 size isn't 8 bytes on this system");
static_assert(sizeof(glm::mediump_u64vec4) == 32, "int64 size isn't 8 bytes on this system");
static_assert(sizeof(glm::highp_u64vec4) == 32, "int64 size isn't 8 bytes on this system");
...
static_assert(sizeof(glm::lowp_u8vec4) == 4, "uint8 size isn't 1 byte on this system");
static_assert(sizeof(glm::mediump_u8vec4) == 4, "uint8 size isn't 1 byte on this system");
static_assert(sizeof(glm::highp_u8vec4) == 4, "uint8 size isn't 1 byte on this system");

static_assert(sizeof(glm::lowp_u16vec4) == 8, "uint16 size isn't 2 bytes on this system");
static_assert(sizeof(glm::mediump_u16vec4) == 8, "uint16 size isn't 2 bytes on this system");
static_assert(sizeof(glm::highp_u16vec4) == 8, "uint16 size isn't 2 bytes on this system");

static_assert(sizeof(glm::lowp_u32vec4) == 16, "uint32 size isn't 4 bytes on this system");
static_assert(sizeof(glm::mediump_u32vec4) == 16, "uint32 size isn't 4 bytes on this system");
static_assert(sizeof(glm::highp_u32vec4) == 16, "uint32 size isn't 4 bytes on this system");

static_assert(sizeof(glm::lowp_u64vec4) == 32, "uint64 size isn't 8 bytes on this system");
static_assert(sizeof(glm::mediump_u64vec4) == 32, "uint64 size isn't 8 bytes on this system");
static_assert(sizeof(glm::highp_u64vec4) == 32, "uint64 size isn't 8 bytes on this system");
